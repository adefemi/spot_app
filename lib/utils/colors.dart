...
class ColorList{
  ...
  Color lightBlue1 = Color(0xffF3F0FF);
  Color blueLight = Color(0xff63E0F9);
  Color lightBlack = Color(0xffF6F6F6);
  Color searchWhite = Color(0xffFBFBFF);
  Color radarBlue = Color(0xffD2D2FF);
  Color radarSearch = Color(0xffB5B5FF);
