...
class VisitingSpotter extends StatefulWidget {
  const VisitingSpotter(this.showSideBar);
  final Function showSideBar;

  @override
  _VisitingSpotterState createState() => _VisitingSpotterState();
}

class _VisitingSpotterState extends State<VisitingSpotter> {
            ...
            Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: Padding(
                    ...
                    child: headingRole2(context, "Hassan Stores", togNav: widget.showSideBar, colorMain: colors.blueColor, canGoBack: true, solid: true),
                  ),
                  elevation: 0,
                  backgroundColor: Colors.transparent,
                ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Row(
                              ...
                              children: <Widget>[
                                textControl("Visiting Spotters", context, size: 25, fontWeight: FontWeight.bold, color: colors.blueColor3),
                            ...
                            SizedBox(height: getSize(context, 20),),
                            textControl("All Spotter | 20", context, size: 20, fontWeight: FontWeight.bold, color: colors.blueColor3),
                            SizedBox(height: getSize(context, 20),),
