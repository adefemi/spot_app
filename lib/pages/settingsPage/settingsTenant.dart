                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                textControl("Temi Alade", context, size: 16, color: Colors.white.withOpacity(0.9), fontWeight: FontWeight.w600)
                              ],
                            ),
                            GestureDetector(
                              onTap: () => gotoPage(context, "/tenantProfile", repNamed: false),
                              child: insertContent(context, color: Colors.white.withOpacity(0.3), child: insertContent(context, width: 38, height: 38,
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    settingListContent(context, "assets/svgs/cart2.svg", "Change Interests", onTap: () => gotoPage(context, "/userInterest", repNamed: false)),
                    settingListContent(context, "assets/svgs/bell.svg", "Notifications", canToggle: true),
                    settingListContent(context, "assets/svgs/userSetting.svg", "Profile", onTap: () => gotoPage(context, "/tenantProfile", repNamed: false)),
